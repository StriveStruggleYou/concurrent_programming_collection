...
import org.ssy.demo1.TradeTransactionInDBHandler;
...
public class Demo2 {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    RingBuffer<TradeTransaction> ringBuffer = RingBuffer
        .createSingleProducer(eventFactory, BUFFER_SIZE);
    ...
    WorkerPool<TradeTransaction> workerPool = new WorkerPool<TradeTransaction>(ringBuffer,
        sequenceBarrier, new IgnoreExceptionHandler(), workHandlers);
